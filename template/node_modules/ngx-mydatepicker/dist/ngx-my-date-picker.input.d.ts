import { ElementRef, ViewContainerRef, ChangeDetectorRef, ComponentFactoryResolver, EventEmitter, SimpleChanges, OnChanges, OnDestroy } from "@angular/core";
...
export declare class NgxMyDatePickerDirective implements OnChanges, OnDestroy, ControlValueAccessor, Validator {
    ...
    onTouchedCb: () => void;
    constructor(utilService: UtilService, vcRef: ViewContainerRef, cfr: ComponentFactoryResolver, cdr: ChangeDetectorRef, elem: ElementRef, config: NgxMyDatePickerConfig);
