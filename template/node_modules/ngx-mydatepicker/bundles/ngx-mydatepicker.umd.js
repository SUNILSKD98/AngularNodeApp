...
var NgxMyDatePicker = (function () {
    function NgxMyDatePicker(elem, cdr, utilService) {
        var _this = this;
        this.elem = elem;
        this.cdr = cdr;
        ...
        this.onClickListener = function (evt) { return _this.onClick(evt); };
    }
    NgxMyDatePicker.prototype.ngOnDestroy = function () {
        this.removeListener();
    };
    NgxMyDatePicker.prototype.addListener = function () {
        this.elem.nativeElement.addEventListener("click", this.onClickListener);
    };
    NgxMyDatePicker.prototype.removeListener = function () {
        this.elem.nativeElement.removeEventListener("click", this.onClickListener);
    };
    NgxMyDatePicker.prototype.onClick = function (evt) {
...
var NgxMyDatePickerDirective = (function () {
    function NgxMyDatePickerDirective(utilService, vcRef, cfr, cdr, elem, config) {
        var _this = this;
        this.utilService = utilService;
        this.vcRef = vcRef;
        this.cfr = cfr;
    ...
    NgxMyDatePickerDirective.prototype.setDisabledState = function (isDisabled) {
        ...
        var nativeElement = this.elem.nativeElement;
        if (isDisabled) {
